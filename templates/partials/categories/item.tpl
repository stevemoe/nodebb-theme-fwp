<li component="categories/category" data-cid="{../cid}" data-numRecentReplies="1"
    ...
    <div class="content col-xs-12 <!-- IF config.hideCategoryLastPost -->col-md-10 col-sm-12<!-- ELSE -->col-md-7 col-sm-9<!-- ENDIF config.hideCategoryLastPost -->">
        <div class="relative">
            <svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 83.5 76.6"
                 style="{function.generateCategorySVGBackground}" xml:space="preserve"
                 class="icon pull-left max-w-[50px] p-0">
            ...
            <div class="absolute">
                <i class="fa fa-fw icon pull-left {../icon}"></i></div>
    ...
    <div class="col-md-1 hidden-sm hidden-xs stats">
        <span class="{../unread-class} human-readable-number"
              title="{../totalTopicCount}">{../totalTopicCount}</span><br/>
        <small>[[global:topics]]</small>
    </div>
    <div class="col-md-1 hidden-sm hidden-xs stats">
        <span class="{../unread-class} human-readable-number"
              title="{../totalPostCount}">{../totalPostCount}</span><br/>
